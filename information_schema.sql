...
-- Tiempo de generación: 08-08-2026 a las 04:17:33
...
--
-- Estructura Stand-in para la vista `KEY_PERIOD_USAGE`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `OPTIMIZER_COSTS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `PERIODS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_CFSTATS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_CF_OPTIONS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_COMPACTION_STATS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_DBSTATS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_DDL`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_DEADLOCK`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_GLOBAL_INFO`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_INDEX_FILE_MAP`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_LOCKS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_PERF_CONTEXT`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_PERF_CONTEXT_GLOBAL`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_SST_PROPS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `ROCKSDB_TRX`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `SEQUENCES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `SLAVE_STATUS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `THREAD_POOL_GROUPS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `THREAD_POOL_QUEUES`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `THREAD_POOL_STATS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `THREAD_POOL_WAITS`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura para la vista `KEY_PERIOD_USAGE`
--
...
--
-- Estructura para la vista `OPTIMIZER_COSTS`
--
...
--
-- Estructura para la vista `PERIODS`
--
...
--
-- Estructura para la vista `ROCKSDB_CFSTATS`
--
...
--
-- Estructura para la vista `ROCKSDB_CF_OPTIONS`
--
...
--
-- Estructura para la vista `ROCKSDB_COMPACTION_STATS`
--
...
--
-- Estructura para la vista `ROCKSDB_DBSTATS`
--
...
--
-- Estructura para la vista `ROCKSDB_DDL`
--
...
--
-- Estructura para la vista `ROCKSDB_DEADLOCK`
--
...
--
-- Estructura para la vista `ROCKSDB_GLOBAL_INFO`
--
...
--
-- Estructura para la vista `ROCKSDB_INDEX_FILE_MAP`
--
...
--
-- Estructura para la vista `ROCKSDB_LOCKS`
--
...
--
-- Estructura para la vista `ROCKSDB_PERF_CONTEXT`
--
...
--
-- Estructura para la vista `ROCKSDB_PERF_CONTEXT_GLOBAL`
--
...
--
-- Estructura para la vista `ROCKSDB_SST_PROPS`
--
...
--
-- Estructura para la vista `ROCKSDB_TRX`
--
...
--
-- Estructura para la vista `SEQUENCES`
--
...
--
-- Estructura para la vista `SLAVE_STATUS`
--
...
--
-- Estructura para la vista `THREAD_POOL_GROUPS`
--
...
--
-- Estructura para la vista `THREAD_POOL_QUEUES`
--
...
--
-- Estructura para la vista `THREAD_POOL_STATS`
--
...
--
-- Estructura para la vista `THREAD_POOL_WAITS`
--
